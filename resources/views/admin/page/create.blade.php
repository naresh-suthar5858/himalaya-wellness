                        ...
                        <form action="{{ route('page.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="meta_tag" name="meta_tag"
                                    class="form-control @error('meta_tag') border-danger @enderror" value="{{ old('meta_tag') }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="meta_title" name="meta_title"
                                    class="form-control @error('meta_title') border-danger @enderror" value="{{ old('meta_title') }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="meta_description" name="meta_description"
                                    ...
                                    placeholder="Short Description">{{ old('meta_description') }}</textarea>
