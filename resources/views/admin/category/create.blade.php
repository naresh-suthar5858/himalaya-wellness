                        ...
                        <form action="{{ route('category.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="show_in_menu" aria-describedby="emailHelp"
                                    ...
                                    <option value="1"{{ old('show_in_menu')==1?'selected':'' }}>No</option>
                                    <option value="2"{{ old('show_in_menu')==2?'selected':'' }}>Yes</option>
                                </select>
                                @error('show_in_menu')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="status" aria-describedby="emailHelp"
                                    ...
                                    <option value="0"{{ old('status')==2?'selected':'' }}>Disable</option>
                                </select>
                                @error('status')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="meta_tag" aria-describedby="emailHelp"
                                    placeholder="Enter meta_tag" name="meta_tag" value="{{ old('meta_tag') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="meta_title" aria-describedby="emailHelp"
                                    placeholder="Enter meta_title" name="meta_title" value="{{ old('meta_title') }}">
